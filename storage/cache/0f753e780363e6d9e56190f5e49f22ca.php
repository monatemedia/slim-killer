<?php $__env->startSection('title', 'Mortgage Calculator'); ?>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .metric-card.primary { grid-column: 1; }
    }
</style>
<?php $__env->stopPush(); ?>

<?php $__env->startSection('content'); ?>
<section class="container mx-auto px-6 py-12" x-data="mortgageCalculator()">

    <div class="text-center mb-10">
        <h1 class="text-4xl font-bold text-slate-900 mb-3">Mortgage Calculator</h1>
        <p class="text-slate-500 max-w-lg mx-auto leading-relaxed">
            Work out your <strong class="text-slate-700">monthly payment</strong> and <em class="text-slate-700">total cost of credit</em> on a home or business loan.
        </p>
    </div>
        ...
        <div class="calc-sidebar h-fit">
            ...
            <div class="param-group">
                <label class="param-label">
                    Loan Term &nbsp;
                    <span class="param-value-display accent" x-text="years + ' yrs'"></span>
                </label>
            ...
            <div class="panel">
                ...
                <div class="visual-bars">
                    <div class="bar-row">
                        ...
                        <div class="bar-track">
                            <div class="bar-fill capital" :style="'width:' + capitalPct + '%'"></div>
                        </div>
                    ...
                    <div class="bar-row">
                        ...
                        <div class="bar-track">
                            <div class="bar-fill interest" :style="'width:' + interestPct + '%'"></div>
                        </div>
                        <span class="bar-amount">
            ...
            <div class="panel" x-data="{ openTable: false }">
                <div class="amortization-toggle" @click="openTable = !openTable">
                    <div class="panel-title" style="margin-bottom:0;">
                        ...
                        <span class="text-xs font-normal text-slate-400 ml-1" x-text="'(' + schedule.length + ' payments)'"></span>
                    </div>
                    <div class="toggle-icon" x-text="openTable ? '−' : '+'"></div>
                </div>
...
function mortgageCalculator() {
    return {
        ...
        init() {
            this.$watch('loanAmount', () => this.calculate());
            this.$watch('interestRate', () => this.calculate());
            this.$watch('years', () => this.calculate());
        ...
        calculate() {
            ...
            for (let i = 1; i <= n; i++) {
                ...
                let dateString = payDate.toLocaleDateString('en-ZA', { year: 'numeric', month: 'short' });
            ...
            if (this.schedule.length > 0) {
                ...
                this.firstMonthPrincipal = this.schedule[0].principalPaid;
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\slim-killer\resources\views/calculator.blade.php ENDPATH**/ ?>