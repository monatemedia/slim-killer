...
<?php $__env->startSection('title', 'Manage Home — Apply for your loan in minutes'); ?>
        ...
        <div class="container flex flex-col-reverse md:flex-row items-center px-6 mx-auto mt-10 space-y-0 md:space-y-0">
            <div class="flex flex-col mb-32 space-y-12 md:w-1/2">
                ...
                <p class="max-w-sm text-center text-sky-900 md:text-left">
                    "Manage contains all the information I've learnt over almost 15 years of buying, selling and managing property investments."
                </p>
                <p class="max-w-sm text-center text-sky-900 md:text-left">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\slim-killer\resources\views/home.blade.php ENDPATH**/ ?>